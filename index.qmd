...
:::
::: {.column width=50%}
![](img/image_gpt_impactdrought.jpeg)
:::
:::
...
- Analyze drought impacts on land cover change and identify `main drivers` of land cover trend across Chile.
...
- The models explained higher for shrublands and croplands.
...
- Even drought-tolerant vegetation types are vulnerable.
